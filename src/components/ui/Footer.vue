<template>
  <div>
    <footer class="nj-dark p-5 text-center text-white">
      ...
      <div class="social-networks py-5">
        <div class="footer-socials flex items-center justify-center gap-2">
          ...
          <a class="btn btn-outline btn-success"
            ...
            >
              ...
              /></svg
          ></a>
          <a class="btn btn-outline btn-accent"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
      ...
      <div class="footer-col my-5">
        <div class="lable-group flex items-center">
          <label
            class="social-networks-title text-xs uppercase text-start block text-nj-white-50"
            >руководство по азартным играм
          </label>
          <span class="footer-line"></span>
        </div>

        <ul class="footer-list flex flex-col gap-2 pt-2">
          <li class="footer-item flex items-center gap-2 sm justify-start">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
            ...
            <a class="footer-link sm" href="#">Как начать играть</a>
          </li>
          <li class="footer-item flex items-center gap-2 sm justify-start">
            <svg
              class="text-primary"
      ...
      <div class="footer-partners">
        <div class="footer__partners flex flex-wrap justify-center gap-2">
          ...
          >
            <g class="svg__color">
              <path
                d="M8.723 16.682a7.514 7.514 0 100-15.028 7.514 7.514 0 000 15.028z"
                fill="#26A17B"
              ></path>
              <path
          ...
          >
            <g class="svg__color">
              <g clip-path="url(#discover_svg__a)">
                ...
                <path
                  ...
                  fill="url(#discover_svg__b)"
                ></path>
                <path
                  opacity=".65"
                  d="M56.199 7.775a7.662 7.662 0 11-15.325.017A7.662 7.662 0 0156.2 7.775z"
                  fill="url(#discover_svg__c)"
            ...
            <g class="svg__mono">
              <g clip-path="url(#discover_svg__d)">
                ...
                ></path>
                <path
                  d="M56.199 7.775a7.662 7.662 0 11-15.323.017 7.662 7.662 0 0115.323-.017z"
                  fill="#4A5370"
                ></path>
              </g>
              <defs>
